...
import second from "../assets/section5/graph.svg";
import leftImage from "../assets/section5/left-stats.svg";
import leftImageMob from "../assets/section5/left-stats-mob.svg";
import rightImage from "../assets/section5/right-stats.svg";
import rightImageMob from "../assets/section5/right-stats-mob.svg";
      ...
      <div className="max-w-[1200px] mx-auto h-full p-4 lg:p-0">
        <div className="lg:h-[465px] flex justify-between">
          <div className="left-side flex-1 h-full">
            ...
            <h4 className="lg:text-lg lg:w-[80%] mt-9 font-medium">
